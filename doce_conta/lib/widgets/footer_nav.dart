...
class BootomNavigationBarDefault extends StatefulWidget {
  ...
  @override
  State<BootomNavigationBarDefault> createState() => _BootomNavigationBarDefaultState();
}

class _BootomNavigationBarDefaultState extends State<BootomNavigationBarDefault> {
      ...
      bottomNavigationBar:  BottomNavigationBar(
        items: [
          BottomNavigationBarItem(
            ...
            color: _selectPosition == 0 ?  Color(0xFFF5A001) : Color.fromARGB(255, 158, 103, 0),
            height: 75, width: 75,
            ),
          ...
          BottomNavigationBarItem(
            ...
            // ignore: deprecated_member_use
            color: _selectPosition == 1 ?  Color(0xFFF5A001) : Color.fromARGB(255, 158, 103, 0),
            height: 65, width: 65,
            ),
            backgroundColor: const Color(0xFF00382B),
            label: '',
          ...
          BottomNavigationBarItem(
            ...
            // ignore: deprecated_member_use
            color: _selectPosition == 2 ?  Color(0xFFF5A001) : Color.fromARGB(255, 158, 103, 0),
            height: 65, width: 65,
            ),
            backgroundColor: const Color(0xFF00382B),
            label: '',
          ...
          BottomNavigationBarItem(
            ...
            // ignore: deprecated_member_use
            color: _selectPosition == 3 ?  Color(0xFFF5A001) : Color.fromARGB(255, 158, 103, 0),
            height: 65, width: 65,
            ),
            backgroundColor: const Color(0xFF00382B),
            label: '',
